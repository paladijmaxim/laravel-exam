...
class SanctumWebMiddleware
{
     ...
     */
    public function handle(Request $request, Closure $next): Response // миделверка для поиска токена в сессии чтобы вставить в заголовок
    {
